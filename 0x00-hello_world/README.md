Preprocessor : A script that runs a C code file through the preprocessor and save the result into another file.
The C file name will be saved in the variable $CFILE.
The output should be saved in the file c.
Export main c file : export CFILE=main.c then run script.
Compiler : A script that compiles a C code file but does not link.
The C file name will be saved in the variable $CFILE.
